...
{
    public:
    MonocularInertialSlamNode(const std::string& node_name)
    : Node(node_name)
    {
        RCLCPP_INFO(this->get_logger(), "SLAM Node has been started in Monocular-Inertial mode.");
        ...
        SLAM = std::make_unique<ORB_SLAM3::System>(orb_voc_path_, settings_path_, ORB_SLAM3::System::IMU_MONOCULAR, visualization);
        ...
        rgb_sub = this->create_subscription<sensor_msgs::msg::Image>(
            "rgb", 10, std::bind(&MonocularInertialSlamNode::rgb_callback, this, _1)
        );
        
        imu_sub_ = this->create_subscription<sensor_msgs::msg::Imu>(
            "imu", 10, std::bind(&MonocularInertialSlamNode::imu_callback, this, _1)
        );
...
private:
    ...
    */
    void slam_loop()
    {
        ...
        Sophus::SE3f Tcw = SLAM->TrackMonocular(gray_frame, tframe, vImuMeas);
...
int main(int argc, char* argv[])
{
    ...
    auto node = std::make_shared<MonocularInertialSlamNode>("slam_monocular_inertial_node");
